...
const resources = {
  en: {
    translation: {
      site: {
        ...
        description: "Alya Al Siyabi is a Systems Analyst and Developer at AMAN Consultancy & Business Development, based in Muscat, Oman."
      },
      nav: {
        about: "ABOUT",
  ...
  ar: {
    translation: {
      site: {
        title: "علياء السيابية — محللة نظم ومطورة برمجيات",
        description: "علياء السيابية هي محللة نظم ومطورة في شركة أمان للاستشارات وتطوير الأعمال، مقيمة في مسقط، سلطنة عمان."
      },
      nav: {
        about: "نبذة عني",
      ...
      hero: {
        eyebrow: "محللة نظم ومطورة برمجيات",
      ...
      manifesto: {
        ...
        stats: {
          experience: { value: "٥+ سنوات", label: "   و البرمجةتحليل النظم والعمليات" },
      ...
      experience: {
        ...
        entries: [
          {
            title: "محللة نظم – قسم التحول الرقمي",
            company: "أمان للاستشارات وتطوير الأعمال",
            period: "2021 – الحالي"
          },
          {
            title: "مهندسة كيميائية متدربة",
            company: "تكاوين للاستشارات الهندسية",
            period: "2018 – 2019"
          },
          {
      ...
      education: {
        ...
        workshops: [
          ...
          "شهادة المبتدئ في تحليل الأعمال (ECBA)",
          "شهادة محو الأمية الرقمية (IC3)",
      ...
      projects: {
        ...
        list: [
          {
            name: "شركة النخبة (Elite Company)",
            role: "مطور / محلل نظم",
          ...
          {
            name: "نظام الاحتضان والتساند (Tassaid)",
            role: "مطور / محلل نظم",
